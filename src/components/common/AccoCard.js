...
export default class AccoCard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            width: 0,
    ...
    render() {
        const {name, email, dataImage, contact} = this.props;
            ...
            >
                ...
                >
                    ...
                    <div className="Team__card-info">
                        ...
                        <p><a className={"Team__a"} href={`tel:${contact}`} title={name}>{contact}</a></p>
                    </div>
                </div>
